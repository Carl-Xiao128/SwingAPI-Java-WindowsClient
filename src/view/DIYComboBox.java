 ...
 * @描述：自定义下拉框 
 * @创建人：kitxiao
 * @创建时间：2016年8月25日下午9:35:44
 */
@SuppressWarnings({ "rawtypes", "unchecked", "serial" })  
public class DIYComboBox<E> extends JComboBox<E> {  
  
    public static void main(String[] args) {  
  
        UIManager.put("ScrollBarUI", com.sun.java.swing.plaf.windows.WindowsScrollBarUI.class.getName());// 设置滚动条样式为window风格的滚动条样式  
        UIManager.put("ButtonUI", com.sun.java.swing.plaf.windows.WindowsButtonUI.class.getName());// 设置滚动条样式为window风格的滚动条样式  
        ...
        final DIYComboBox<String> comboBox = new DIYComboBox<>(new String[] {"----请选择----","1", "2", "3", "4", "5", "6","1", "2", "3", "4", "5", "6"});  
...
//        comboBox.setSelectionForeground(Color.RED);  
    ...
    public DIYComboBox(ComboBoxModel<E> aModel) {  
        super(aModel);  
        init();  
    }  
  
    public DIYComboBox(E[] items) {  
        super(items);  
        init();  
    }  
  
    public DIYComboBox(Vector<E> items) {  
        super(items);  
        init();  
    }  
  
    public DIYComboBox(Icon arrowIcon) {  
    ...
    private void init() {  
        ...
        Border lineBorder = BorderFactory.createLineBorder(SystemColor.gray);  
...
//         getPopup().setBackground(popupBackground);  
    ...
    public Icon getArrowIcon() {  
        if (arrowIcon == null) {  
            arrowIcon = new ArrowIcon(12, 8, 8, 8, Color.decode("#666"), SwingConstants.BOTTOM);  
        }  
        return arrowIcon;  
    }  
    ...
    public static class CustomComboBoxUI extends WindowsComboBoxUI {  
        ...
        protected JButton createArrowButton() {  
            final DIYComboBox box = (DIYComboBox) comboBox;  
