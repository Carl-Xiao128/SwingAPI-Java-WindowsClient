...
/**
 * @项目名称：SalesInvoiceSys
 * @类名称：DateChooser
 * @类描述：日期选择器，可以指定日期的显示格式
 * @创建人：肖龙祥
 * @创建时间：2016年8月24日 下午6:04:39 
 * @version：
 */
	...
	*/
	private class JP1 extends JPanel {
		...
		public JP1() {
			...
			this.setBackground(new Color(140,199,247));
			initJP1();
	...
	private class MyLabel extends JLabel
			implements Comparator<MyLabel>, MouseListener, MouseMotionListener {
