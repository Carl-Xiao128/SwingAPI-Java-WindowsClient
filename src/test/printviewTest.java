 ...
 * @author Gaowen
 */
public class printviewTest extends JPanel implements ActionListener, Printable {
	...
	private static void createAndShowGUI() {
		...
		frame.setContentPane(new printviewTest());
		frame.pack();
	...
	private class PreviewArea extends Component {
		...
		public void paint(Graphics g) {
			...
			try {
				printviewTest.this.print(g2, pageFormat, pageIndex);
